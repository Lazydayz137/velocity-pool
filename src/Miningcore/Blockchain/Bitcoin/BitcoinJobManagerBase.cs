...
public abstract class BitcoinJobManagerBase<TJob> : JobManagerBase<TJob>
{
    ...
    protected virtual IDestination AddressToDestination(string address, BitcoinAddressType? addressType)
    {
        ...
        switch(addressType.Value)
        {
            ...
            case BitcoinAddressType.Groestlcoin:
                return BitcoinUtilsExtensions.GroestlcoinAddressToDestination(poolConfig.Address, network);

            case BitcoinAddressType.GroestlcoinBech32:
                return BitcoinUtilsExtensions.GroestlcoinBech32AddressToDestination(poolConfig.Address, network);
